...
#define _malloc_H_
 ...
 /* Define the block size since the sizeof will be wrong */ //how come?
#define BLOCK_SIZE sizeof(struct s_block) //incase on a different compiler the s_block takes up more or less space than 40?
